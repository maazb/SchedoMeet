...
class _AccountState extends State<Account> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (_accountController.loadingUpdateInfo.value == true ||
            _accountController.loadingUpdateInfo.value == true) {
          return false;
        } else {
          return true;
        }
      ...
      child: Stack(
        children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      CupertinoButton(
                        ...
                        minSize: 0.0001,
                        onPressed: () {
                          _navigationController.persistentTabController
                              .jumpToTab(0);
                        },
                        child: Container(
          ...
          Obx(
            () => Positioned(
                child: _accountController.loadingUpdateInfo.value == true
                    ? FullScreenLoader()
                    : Container()),
          )
        ],
