            ...
            Container(
              ...
              child: Column(
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: Obx(
                              () =>
                                  loadDataController.unseenMeetingsList.isEmpty
                                      ? Column(
                                          mainAxisAlignment:
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  '${loadDataController.unseenMeetingsList[index].title}',
                                                                  style: GoogleFonts
                                                                      .poppins(
                                                                    textStyle: TextStyle(
                                                                        color: brown,
                                                                ...
                                                                .symmetric(
                                                                    ...
                                                                    vertical:
                                                                        height *
                                                                            0.005),
                                                            child: Text(
                                                              '${loadDataController.unseenMeetingsList[index].detail}',
                                                              overflow:
                                                                  TextOverflow
                                                                      .ellipsis,
                                                              maxLines: 2,
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  DateFormat("hh:mm a").format(loadDataController
                                                                          .unseenMeetingsList[
                                                                              index]
                                                                          .startTime!) +
                                                                      " - " +
                                                                ...
                                                                CupertinoButton(
                                                                    ...
                                                                    child: SizedBox(
                                                                        ...
                                                                        child: ListView.builder(
                                                                            scrollDirection: Axis.horizontal,
                                                                            itemCount: loadDataController.meetingsList[index].attendees!.length < 3 ? loadDataController.meetingsList[index].attendees!.length : 3,
                                                                                ...
                                                                                child: CircleAvatar(
                                                                                  ...
                                                                                  child: ind == 2
                                                                                      ? CircleAvatar(
                                                                                          ...
                                                                                          child: Text(
                                                                                            '+' + (loadDataController.meetingsList[index].attendees!.length - 2).toString(),
                                                                                            style: GoogleFonts.poppins(
                                                                                              textStyle: TextStyle(
                                                                                                  color: white,
                                                                                                  //height: 1.3,
                  ...
                  Obx(
                    () => Container(
                      child: loadDataController.loadingEvents.value
                          ? Column(
                          ...
                          : loadDataController.eventsList.isEmpty
                              ? Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                              ...
                              : Obx(
                                  () => ListView.builder(
                                      itemCount:
                                          loadDataController.eventsList.length,
                                      shrinkWrap: true,
                                      physics:
