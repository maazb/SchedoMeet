...
class _EventFailureState extends State<EventFailure> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (_calendarController.loadingAddEvent.value == true ||
            _calendarController.loadingAddEvent.value == true) {
          return false;
        } else {
          return true;
        }
      ...
      child: Stack(
        children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      child: _calendarController.recomendationList.isEmpty
                          ? Container(
                              width: width * 0.7,
                              child: CupertinoButton(
                                padding: EdgeInsets.all(0.0),
                    ...
                    Container(
                      child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount:
                              _calendarController.recomendationList.length,
          ...
          Obx(
            () => Positioned(
                child: _calendarController.loadingAddEvent.value == true
                    ? FullScreenLoader()
                    : Container()),
          )
        ],
